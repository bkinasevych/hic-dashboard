...
org_list <- site$get_list("tbl_organizations")
...
rm(fees_list, org_list, projects_list)
...
organizations <- organizations |>
  clean_names() |> 
  rename("org_id" = id) |> 
  mutate(org_id = as.double(org_id)) |> 
  select(
    org_id, org_name, sector, location, indigenous
  )
